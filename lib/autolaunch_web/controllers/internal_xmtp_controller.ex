defmodule AutolaunchWeb.InternalXmtpController do
  ...
  defp render_unprocessable(conn, code) do
    ApiError.render(conn, :unprocessable_entity, code, "Room request could not be completed.")
  end
  ...
  defp with_existing_command(conn, command_fun) when is_function(command_fun, 0) do
    ...
    Ecto.NoResultsError ->
      ApiError.render(conn, :not_found, "command_not_found", "Room command could not be found.")
  end
