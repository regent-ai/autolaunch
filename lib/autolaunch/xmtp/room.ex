defmodule Autolaunch.Xmtp.Room do
  @moduledoc false
  use Autolaunch.Schema

  schema "autolaunch_xmtp_rooms" do
    ...
    has_many :memberships, Autolaunch.Xmtp.RoomMembership
    has_many :message_logs, Autolaunch.Xmtp.MessageLog
