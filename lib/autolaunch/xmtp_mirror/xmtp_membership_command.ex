defmodule Autolaunch.XMTPMirror.XmtpMembershipCommand do
  @moduledoc false
  ...
  schema "xmtp_membership_commands" do
    ...
    belongs_to :room, Autolaunch.XMTPMirror.XmtpRoom
    belongs_to :human_user, Autolaunch.Accounts.HumanUser
